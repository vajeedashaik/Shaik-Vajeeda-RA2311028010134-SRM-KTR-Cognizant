...
public class Exercise7_FinancialForecasting {
    ...
    // Naive recursive: O(n) — linear chain, one call per year (no branching)
    ...
    // Iterative (best): O(n) time, O(1) space — no stack overflow risk
    ...
    // Closed-form (mathematical): O(1) — FV = PV * (1 + r)^n
    ...
    public static void main(String[] args) {
         ...
         *   Closed-form      -> O(1) — optimal for this specific formula
         *
