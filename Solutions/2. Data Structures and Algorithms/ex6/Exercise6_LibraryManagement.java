...
public class Exercise6_LibraryManagement {
    ...
    // O(log n) — array must be sorted alphabetically by title
    ...
    public static void main(String[] args) {
         ...
         *
         * Small or unsorted collections: linear search — no overhead.
         * Large, sorted, read-heavy collections: binary search — dramatic speedup.
